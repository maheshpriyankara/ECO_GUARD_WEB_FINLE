    ...
    <script type="text/javascript">
        ...
        function loadPeriodList() {
            $.ajax({
                ...
                url: "http://geryjdakdai-001-site12.atempurl.com/api/SalaryLock/getPeriodListAll",
                                                ...
                                                <script type="text/javascript">
                                                    function lockSalary() {
                                                        $.ajax({
                                                            ...
                                                            url: "http://geryjdakdai-001-site12.atempurl.com/api/ProcessSalary/CheckEmployeeAll?period_=" + document.getElementById('list_period').value,
                                                            ...
                                                            success: function (data) {
                                                                if (data == 2) {
                                                                    ...
                                                                    alert("Selected Period Have Un-Sucessfull Processed Profile's. Please Request on Settings > Un-Successfull Process Request ,and try again..")
                                                                    $("#loading").css("visibility", "hidden");
                                                                } else {
                                                                    var url = '';
                                                                    if (document.getElementById('list_typeReportOT').value == 'OverTime ( Selected Month )') {
                                                                        url = "http://geryjdakdai-001-site12.atempurl.com/api/Export/GetOTAll?period=" + document.getElementById('list_period').value
                                                                    } else if (document.getElementById('list_typeReportOT').value == 'OverTime ( Audit )') {
                                                                        url = "http://geryjdakdai-001-site12.atempurl.com/api/Export/GetOTAllAudit?period=" + document.getElementById('list_period').value
                                                                    } else if (document.getElementById('list_typeReportOT').value == 'WorkHours ( Selected Month )') {
                                                                        url = "http://geryjdakdai-001-site12.atempurl.com/api/Export/GetWorkHours?period=" + document.getElementById('list_period').value
                                                                    } else if (document.getElementById('list_typeReportOT').value == 'WorkHours ( Audit )') {
                                                                        url = "http://geryjdakdai-001-site12.atempurl.com/api/Export/GetWorkHoursAudit?period=" + document.getElementById('list_period').value
                                                                    }
                                                                    $.ajax({
                                                                        beforeSend: function () {
                                                                            $("#loading").css("visibility", "visible");
                                                ...
                                                <script type="text/javascript">
                                                    ...
                                                    function invokeJavaScript() {
                                                        ...
                                                        $.ajax({
                                                            ...
                                                            url: "http://geryjdakdai-001-site12.atempurl.com/api/ProcessSalary/CheckEmployeeAll?period_=" + document.getElementById('list_period2').value,
                                                            ...
                                                            success: function (data) {
                                                                if (data == 2) {
                                                                    ...
                                                                    if (document.getElementById('list_type2').value == 'No Pay Report') {
                                                                        url = "http://geryjdakdai-001-site12.atempurl.com/api/Export/GetNoPaySummary?period=" + document.getElementById('list_period2').value
                                                                    } else if (document.getElementById('list_type2').value == 'No Pay Report ( Detail )') {
                                                                        url = "http://geryjdakdai-001-site12.atempurl.com/api/Export/GetNoPaySummaryDetail?period=" + document.getElementById('list_period2').value
                                                                    }
                                                                    $.ajax({
                                                                        beforeSend: function () {
                                                                            $("#loading").css("visibility", "visible");
                                            ...
                                            <script type="text/javascript">
                                                ...
                                                function invokeJavaScript2() {
                                                    $.ajax({
                                                        ...
                                                        url: "http://geryjdakdai-001-site12.atempurl.com/api/ProcessSalary/CheckEmployeeAll?period_=" + document.getElementById('list_period3').value,
                                                        ...
                                                        success: function (data) {
                                                            if (data == 2) {
                                                                ...
                                                                if (document.getElementById('list_type3').value == 'Deduction') {
                                                                    url = "http://geryjdakdai-001-site12.atempurl.com/api/Export/GetDeductionSummary?period=" + document.getElementById('list_period3').value
                                                                } else if (document.getElementById('list_type3').value == 'Allowances') {
                                                                    url = "http://geryjdakdai-001-site12.atempurl.com/api/Export/GetAllowanceSummary?period=" + document.getElementById('list_period3').value
                                                                } else if (document.getElementById('list_type3').value == 'Payee') {
                                                                    url = "http://geryjdakdai-001-site12.atempurl.com/api/Export/GetPayeeSummary?period=" + document.getElementById('list_period3').value
                                                                }
                                                                $.ajax({
                                                                    beforeSend: function () {
                                                                        $("#loading").css("visibility", "visible");
