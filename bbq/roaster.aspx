...
<head>
    ...
    <script type="text/javascript">
        function loadRoasterMonth(epfno) {
            loadAttRow(epfno)
            $.ajax({
                url: "http://geryjdakdai-001-site12.atempurl.com/api/roaster/getroasterAttendancemonth?empname=" + epfno + "&year=" + document.getElementById('date_search').value + "&month=" + document.getElementById('list_month').value + "&empid=" + document.getElementById('text_attendanceId').value,
                beforeSend: function () {
                    ...
                    $.ajax({
                        ...
                        success: function (data2) {
                            if (data2 == 1) {
                                ...
                                $.ajax({
                                    url: "http://geryjdakdai-001-site12.atempurl.com/api/roaster/getroasterlist",
                                    success: function (roasterListData) {
                                        ...
                                        $.each(data, function (index, value) {
                                            ...
                                            roasterFirstSelect.change(function () {
                                                ...
                                                $.ajax({
                                                    url: "http://geryjdakdai-001-site12.atempurl.com/api/roaster/updateRoaster?empname=" + epfno + "&date=" + selectedDate + "&roaster=" + selectedRoaster + "&mode=1" + "&empid=" + document.getElementById('text_attendanceId').value,
                                                    beforeSend: function () {
                                                        $("#loading").css("visibility", "visible");
                                                    },
                                                    type: "PUT",
                                                    success: function (data) {
                                                        $.ajax({
                                                            url: "http://geryjdakdai-001-site12.atempurl.com/api/ProcessSalary/PushEmployeeDay?epfno=" + epfno + "&period=" + document.getElementById('date_search').value + "/" + document.getElementById('list_month').value + "&requestFrom=Shift Update (First)&user_=_&ip=" + selectedDate + "&empid=" + document.getElementById('text_attendanceId').value + "&empid=" + document.getElementById('text_attendanceId').value,
                                                            type: "PUT",
                                                            success: function (data) {
                                                            }
                                                        });
                                            ...
                                            roasterSecondSelect.change(function () {
                                                ...
                                                $.ajax({
                                                    ...
                                                    url: "http://geryjdakdai-001-site12.atempurl.com/api/roaster/updateRoaster?empname=" + epfno + "&date=" + selectedDate + "&roaster=" + selectedRoaster + "&mode=2" + "&empid=" + document.getElementById('text_attendanceId').value,
                                                    type: "PUT",
                                                    success: function (data) {
                                                        $.ajax({
                                                            url: "http://geryjdakdai-001-site12.atempurl.com/api/ProcessSalary/PushEmployeeDay?epfno=" + epfno + "&period=" + document.getElementById('date_search').value + "/" + document.getElementById('list_month').value + "&requestFrom=Shift Update (Second)&user_=_&ip=" + selectedDate + "&empid=" + document.getElementById('text_attendanceId').value,
                                                            type: "PUT",
                                                            success: function (data) {
                                                            }
                                                        });
                                            ...
                                            extraOTInput.on("change", function () {
                                                ...
                                                if (regex24.test(value)) {
                                                    ...
                                                    $.ajax({
                                                        ...
                                                        success: function (data) {
                                                            $.ajax({
                                                                url: "http://geryjdakdai-001-site12.atempurl.com/api/ProcessSalary/PushEmployeeDay?epfno=" + epfno + "&period=" + document.getElementById('date_search').value + "/" + document.getElementById('list_month').value + "&requestFrom=Manual Attendance&user_=_&ip=" + selectedDate + "&empid=" + document.getElementById('text_attendanceId').value,
                                                                type: "PUT",
                                                                success: function (data) {
                                                                    $("#loading").css("visibility", "hidden");
                                                                }
    ...
    <script type="text/javascript">
        function loadAttendanceCleaning(epfno) {
            $.ajax({
                url: "http://geryjdakdai-001-site12.atempurl.com/api/attendance/getattmonthCleaning?empname=" + epfno + "&year=" + document.getElementById('date_search').value + "&month=" + document.getElementById('list_month').value + "&empid=" + document.getElementById('text_attendanceId').value,
                beforeSend: function () {
                    $("#loading").css("visibility", "visible");
                },
                success: function (data) {
    ...
    <script type="text/javascript">
        function loadAttRow(epfno2) {
            $.ajax({
                url: "http://geryjdakdai-001-site12.atempurl.com/api/ProcessSalary/CheckEmployee?epfno=" + epfno2 + "&period=" + document.getElementById('date_search').value + "/" + document.getElementById('list_month').value + "&empid=" + document.getElementById('text_attendanceId').value,
                                ...
                                deleteButton.click(function () {
                                    ...
                                    if (confirm("Are you sure you want to delete this row?")) {
                                        ...
                                        $.ajax({
                                            ...
                                            success: function (data) {
                                                $.ajax({
                                                    url: "http://geryjdakdai-001-site12.atempurl.com/api/ProcessSalary/PushEmployeeDayDouble?epfno=" + epfno2 + "&period=" + document.getElementById('date_search').value + "/" + document.getElementById('list_month').value + "&requestFrom=Manual Attendance&user_=_&ip=" + value + "&empid=" + document.getElementById('text_attendanceId').value,
                                                    type: "PUT",
                                                    success: function (data) {
    ...
    <script type="text/javascript">
        function loadLeaveBalance(epfno) {
            ...
            $.ajax({
                ...
                url: "http://geryjdakdai-001-site12.atempurl.com/api/Leave/getLeaveBalance?empname=" + epfno + "&year=" + document.getElementById('date_search').value + "&month=" + document.getElementById('list_month').value + "&empid=" + document.getElementById('text_attendanceId').value,
                beforeSend: function () {
                    $("#loading").css("visibility", "visible");
                },
                success: function (data) {
    ...
    <script type="text/javascript">
        function chnageCheckBox(epfNo, date, columnName, status) {
            $.ajax({
                ...
                url: "http://geryjdakdai-001-site12.atempurl.com/api/roaster/updateRoasterRef?empname=" + epfNo + "&date=" + date + "&columnName=" + columnName + "&status=" + status + "&year=" + document.getElementById('date_search').value + "&empid=" + document.getElementById('text_attendanceId').value,
                type: "PUT",
                success: function (data) {
                    $.ajax({
                        url: "http://geryjdakdai-001-site12.atempurl.com/api/ProcessSalary/PushEmployeeDay?epfno=" + epfNo + "&period=" + document.getElementById('date_search').value + "/" + document.getElementById('list_month').value + "&requestFrom=Advance Leave Update&user_=_&ip=" + date + "&empid=" + document.getElementById('text_attendanceId').value,
                        type: "PUT",
                        success: function (data) {
                        }
                    });
    ...
    <script type="text/javascript">
        function chnageCheckBox2(epfNo, date, columnName, status) {
            $.ajax({
                ...
                url: "http://geryjdakdai-001-site12.atempurl.com/api/roaster/updateAttendanceCleaning?empname=" + epfNo + "&date=" + date + "&columnName=" + columnName + "&status=" + status + "&year=" + document.getElementById('date_search').value + "&empid=" + document.getElementById('text_attendanceId').value,
                type: "PUT",
                success: function (data) {
                    $.ajax({
                        url: "http://geryjdakdai-001-site12.atempurl.com/api/ProcessSalary/PushEmployeeDay?epfno=" + epfNo + "&period=" + document.getElementById('date_search').value + "/" + document.getElementById('list_month').value + "&requestFrom=Advance Leave Update&user_=_&ip=" + date + "&empid=" + document.getElementById('text_attendanceId').value,
                                                                                            ...
                                                                                            if (data != 1) {
                                                                                                $.ajax({
                                                                                                    ...
                                                                                                    success: function (data) {
                                                                                                        loadAttRow(empname);
                                                                                                        $.ajax({
                                                                                                            url: "http://geryjdakdai-001-site12.atempurl.com/api/ProcessSalary/PushEmployeeDayDouble?epfno=" + empname + "&period=" + document.getElementById('date_search').value + "/" + document.getElementById('list_month').value + "&requestFrom=Manual Attendance&user_=_&ip=" + dateTime + "&empid=" + document.getElementById('text_attendanceId').value,
                                                                                                            type: "PUT",
                                                                                                            success: function (data) {
                                                                                                                loadAttRow(empname);
