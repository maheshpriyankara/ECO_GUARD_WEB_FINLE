                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="block">
                                    ...
                                    <div class="form-group has-success">
                                        ...
                                        <script type="text/javascript">
                                            function loadSummaryDate() {
                                                var period = document.getElementById('list_date').value + "/" + document.getElementById('list_month').value;
                                                function lockSalary() {
                                                    $.ajax({
                                                        beforeSend: function () {
                                                            $("#loading").css("visibility", "visible");
                                                        },
                                                        url: "http://geryjdakdai-001-site12.atempurl.com/api/ProcessSalary/CheckEmployeeAll?period_=" + period,
                                                        ...
                                                        success: function (data) {
                                                            if (data == 2) {
                                                                ...
                                                                $.ajax({
                                                                    ...
                                                                    url: "http://geryjdakdai-001-site12.atempurl.com/api/Payroll/GetSummaryMonth?year=" + document.getElementById('list_date').value + "&month=" + document.getElementById('list_month').value + "&searchmode=" + document.getElementById('list_paymode').value + "&searchmode2=" + document.getElementById('list_epf').value,
                                                                      success: function (data) {
                                ...
                                <div class="col-md-1">
                                    <div class="form-group has-success">
                                        <asp:Button ID="btn_load" runat="server" Text="Load" CssClass="form-control" BackColor="#009933" ForeColor="White" Font-Bold="true"></asp:Button>
                                        <script type="text/javascript">
