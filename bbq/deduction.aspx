...
<head>
    ...
    <script type="text/javascript">
        function loadFixedValue(epfno, empState) {
            setElement(empState)
            $.ajax({
                url: "http://geryjdakdai-001-site12.atempurl.com/api/OngoingFunction/getFixedValues?empname=" + epfno + "&year=" + document.getElementById('date_search').value + "&month=" + document.getElementById('list_month').value + "&empid=" + document.getElementById('text_attendanceId').value,
    ...
    <script type="text/javascript">
        function loadOngoingValues(epfno2, empState) {
            ...
            $.ajax({
                url: "http://geryjdakdai-001-site12.atempurl.com/api/OngoingFunction/getOngoingValues?empname=" + epfno2 + "&year=" + document.getElementById('date_search').value + "&month=" + document.getElementById('list_month').value + "&empid=" + document.getElementById('text_attendanceId').value,
                        ...
                        deleteButton.click(function () {
                            ...
                            if (confirm("Are you sure you want to delete this row?")) {
                                ...
                                $.ajax({
                                    ...
                                    url: "http://geryjdakdai-001-site12.atempurl.com/api/OngoingFunction/DeleteOngoingValue?entryType=" + value2 + "&id=" + value,
                                    type: "DELETE",
                                    success: function (data) {
                                        document.getElementById('text_totalAdvance').value = ""
                                        document.getElementById('text_totalDeduction').value = ""
                                                    ...
                                                    function myMethod2() {
                                                        ...
                                                        if (empname == "" && attid=="") {
                                                            ...
                                                            $.ajax({
                                                                ...
                                                                url: "http://geryjdakdai-001-site12.atempurl.com/api/OngoingFunction/updateFixedValues?empname=" + empname + "&year=" + year + "&month=" + month + "&rdbLoan=" + rdbLoan + "&staffLoan=" + staffLoan + "&cashShort=" + cashShort + "&advance=" + advance + "&casesAllowance=" + casesAllowance + "&nightAllowance=" + nightAllowance + "&empid=" + document.getElementById('text_attendanceId').value,
                                                                type: "POST",
                                                                success: function (data) {
                                                                    document.getElementById('text_totalAdvance').value = ""
                                                                    document.getElementById('text_totalDeduction').value = ""
                                                                    $.ajax({
                                                                        url: "http://geryjdakdai-001-site12.atempurl.com/api/ProcessSalary/PushEmployee?epfno=" + empname + "&period=" + document.getElementById('date_search').value + "/" + document.getElementById('list_month').value + "&requestFrom=Fixed Value Update&user_=_&ip=_" + "&empid=" + document.getElementById('text_attendanceId').value,
                                                                        type: "PUT",
                                                                        success: function (data) {
                                                            ...
                                                            function myMethod3() {
                                                                ...
                                                                if (empname != "" && attid != "") {
                                                                    ...
                                                                    $.ajax({
                                                                        ...
                                                                        url: "http://geryjdakdai-001-site12.atempurl.com/api/OngoingFunction/updateOngoingValues?empname=" + empname + "&year=" + year + "&month=" + month + "&manualType=" + manualType + "&manualDate=" + manualDate + "&manualAmount=" + manualAmount + "&manualRemark=" + manualRemark + "&empid=" + document.getElementById('text_attendanceId').value,
                                                                        type: "POST",
                                                                        success: function (data) {
                                                                            document.getElementById('text_totalAdvance').value = ""
                                                                            document.getElementById('text_totalDeduction').value = ""
                                                                            ...
                                                                            $.ajax({
                                                                                url: "http://geryjdakdai-001-site12.atempurl.com/api/ProcessSalary/PushEmployee?epfno=" + empname + "&period=" + document.getElementById('date_search').value + "/" + document.getElementById('list_month').value + "&requestFrom=Ongoing Values Update&user_=_&ip=_" + "&empid=" + document.getElementById('text_attendanceId').value,
                                                                                type: "PUT",
                                                                                success: function (data) {
