    ...
    <script type="text/javascript">
        function loadPeriodList2() {
            $.ajax({
                ...
                url: "http://geryjdakdai-001-site12.atempurl.com/api/SalaryLock/getPeriodListAllLock",
        ...
        function loadCalender() {
            $.ajax({
                ...
                url: "http://geryjdakdai-001-site12.atempurl.com/api/Home/GetCalendar",
                success: function (data) {
        ...
        function loadPeriodList() {
            $.ajax({
                ...
                url: "http://geryjdakdai-001-site12.atempurl.com/api/SalaryLock/getPeriodList",
                success: function (data) {
        ...
        function loadLockHistory() {
            $.ajax({
                ...
                url: "http://geryjdakdai-001-site12.atempurl.com/api/SalaryLock/getLockHistory",
                success: function (data) {
                    ...
                    $.each(data, function (index, value) {
                        ...
                        if (value.SmsSend) {
                            ...
                            checkbox.change(function () {
                                ...
                                //        $("#loading").css("visibility", "visible");
                                //    },
                                //    url: "http://geryjdakdai-001-site12.atempurl.com/api/SalaryLock/SmsSalaryRequest?period_=" + period,
                                //    success: function (data) {
                                //        loadLockHistory();
                            ...
                            <div class="block">
                                ...
                                <div class="col-md-6">
                                    <div class="panel panel-default">
                                                ...
                                                <script type="text/javascript">
                                                    function lockSalary() {
                                                        $.ajax({
                                                            ...
                                                            url: "http://geryjdakdai-001-site12.atempurl.com/api/ProcessSalary/CheckEmployeeAll?period_=" + document.getElementById('list_designation').value,

                                                            success: function (data) {
                                                                if (data != 2) {
                                                                    $.ajax({

                                                                        url: "http://geryjdakdai-001-site12.atempurl.com/api/SalaryLock/lockSalary?period_=" + document.getElementById('list_designation').value,
                                                                        type: "POST",
                                                                        success: function (data) {
                                                                            loadPeriodList();
                                                                            loadLockHistory();
                                                ...
                                                <script type="text/javascript">
                                                    function processRequest() {
                                                        $.ajax({
                                                            ...
                                                            url: "http://geryjdakdai-001-site12.atempurl.com/api/ProcessSalary/ProcessRequestAll?period=" + document.getElementById('list_designation').value,
                                                            type: "PUT",
                                                            success: function (data) {
                                        ...
                                        <div class="form-group">
                                            <div class="form-group bootstro-next-btn">
                                                <input type="button" class="form-control" value="Pending Process Request" onclick="processRequest2()" style="background: #4800ff; color: white">
                                                <script type="text/javascript">
                                                    function processRequest2() {
                                                        $.ajax({
                                                            ...
                                                            url: "http://geryjdakdai-001-site12.atempurl.com/api/ProcessSalary/ProcessRequestAllPending?period=" + document.getElementById('list_designation').value,
                                                            type: "PUT",
                                                            success: function (data) {
                                            ...
                                            <div class="form-group bootstro-next-btn">
                                                <input type="button" class="form-control" value="Un-Sucessfull Process Request" onclick="processRequest3()" style="background: #ff00dc; color: white">
                                                <script type="text/javascript">
                                                    function processRequest3() {
                                                        $.ajax({
                                                            ...
                                                            url: "http://geryjdakdai-001-site12.atempurl.com/api/ProcessSalary/ProcessRequestAllUnsucessfull?period=" + document.getElementById('list_designation').value,
                                                            type: "PUT",
                                                            success: function (data) {
                                                                alert("All Process Pending Requested Succesfully");
                                                            },
                                                    ...
                                                    if (type == 'EPF') {
                                                        {
                                                            $.ajax({
                                                                ...
                                                                url: "http://geryjdakdai-001-site12.atempurl.com/api/Export/GenerateTextFilesEPF?period=" + document.getElementById('list_exportEPFETF').value,
                                                                xhrFields: {
                                                        ...
                                                        $.ajax({
                                                            ...
                                                            url: "http://geryjdakdai-001-site12.atempurl.com/api/Export/GenerateTextFilesETF?period=" + document.getElementById('list_exportEPFETF').value,
                                                            xhrFields: {
                                                                responseType: 'blob' // Set the response type to 'blob'
                                                            },
                                                            success: function (data, status, xhr) {
                                                    ...
                                                    if (type == 'EPF') {
                                                        {
                                                            $.ajax({
                                                                ...
                                                                url: "http://geryjdakdai-001-site12.atempurl.com/api/Export/GeneratePDFFilesEPF?period=" + document.getElementById('list_exportEPFETF').value,
                                                                xhrFields: {
                                                                    responseType: 'blob' // Set the response type to 'blob'
                                                                },
                                                                success: function (data, status, xhr) {
                                                        ...
                                                        $.ajax({
                                                            ...
                                                            url: "http://geryjdakdai-001-site12.atempurl.com/api/Export/GeneratePDFFilesETF?period=" + document.getElementById('list_exportEPFETF').value,
                                                            xhrFields: {
                                                                responseType: 'blob' // Set the response type to 'blob'
                                                            },
                                                            success: function (data, status, xhr) {
                                            ...
                                            <script type="text/javascript">
                                                ...
                                                function invokeJavaScript2() {
                                                    ...
                                                    $.ajax({
                                                        ...
                                                        url: "http://geryjdakdai-001-site12.atempurl.com/api/Export/GenerateExcelFileSalary?period=" + period + "&acno=" + acno,
                                                        xhrFields: {
                                                            responseType: 'blob' // Set the response type to 'blob'
                                                        },
                                                        success: function (data, status, xhr) {
                                ...
                                <div class="col-md-6">
                                    <div class="panel panel-default">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group bootstro-next-btn">
                                                <input type="button" class="form-control" value="Update Date" onclick="updateDate()" style="background: #ff6a00; color: white">
                                                <script type="text/javascript">
                                                    function updateDate() {
                                                        $.ajax({
                                                            beforeSend: function () {
                                                            ...
                                                            url: "http://geryjdakdai-001-site12.atempurl.com/api/Home/updateCalendar?date=" + document.getElementById('text_date').value + "&dayType=" + document.getElementById('list_calendarType').value,
                                                            type: "POST",
                                                            success: function (data) {
                                                                loadCalender();
